...
public partial class CommandlineToFormattedTextConverter : IValueConverter
{
    ...
    public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
    {
        ...
        {
            Style = Application.Current.Resources["CommandlineAppStyle"] as Style
        };
    ...
    [GeneratedRegex(@"(?<=^)-*-(?=\w)", RegexOptions.ExplicitCapture, matchTimeoutMilliseconds: 200)]
    private static partial Regex ArgumentFinder();
    [GeneratedRegex(@"(""[^""]+""|\S+)", RegexOptions.ExplicitCapture, matchTimeoutMilliseconds: 200)]
